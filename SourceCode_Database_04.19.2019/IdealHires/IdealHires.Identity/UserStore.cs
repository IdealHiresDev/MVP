...
namespace IdealHires.BAL
{
        ...
        IUserLockoutStore<UserDTO, int>, IUserTwoFactorStore<UserDTO, int>
    {
        ...
        public UserStore(AppUserInfo appUserInfo) //AppUserInfo appUserInfo
        {
        ...
        {
            return null;// Task.FromResult((IList<string>)user.Roles);
        }
        ...
        //    claimIdentity.AddClaim(new Claim(CustomClaims.Email, user.Fullname, ClaimValueTypes.String));
