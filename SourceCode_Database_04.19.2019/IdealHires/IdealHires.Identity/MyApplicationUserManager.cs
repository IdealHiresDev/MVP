...
{
    public class MyApplicationUserManager : UserManager<UserDTO, int>
    {
        public MyApplicationUserManager(IUserStore<UserDTO, int> store)
            : base(store)
        { }
        ...
        {
            var manager = new MyApplicationUserManager(new UserStore(CurrentUser.GetCurrentUserInfo()))
            {
